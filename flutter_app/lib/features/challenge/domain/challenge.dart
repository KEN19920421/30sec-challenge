...
class Challenge {
  ...
  factory Challenge.fromJson(Map<String, dynamic> json) {
    return Challenge(
      ...
      descriptionJa: (json['description_ja'] ?? json['descriptionJa']) as String?,
      ...
      votingEndsAt: DateTime.parse((json['voting_ends_at'] ?? json['votingEndsAt']) as String),
      submissionCount: (json['submission_count'] ?? json['submissionCount']) as int? ?? 0,
      totalVotes: (json['total_votes'] ?? json['totalVotes']) as int? ?? 0,
      isPremiumEarlyAccess: (json['is_premium_early_access'] ?? json['isPremiumEarlyAccess']) as bool? ?? false,
